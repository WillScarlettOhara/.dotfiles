...
keymap = ctx.keymap_new_from_names(
    rules=None, model="pc105", layout=ly, variant=va, options="terminate:ctrl_alt_bksp"
)
...
for key in keysToTest:
    formattedJson[key] = {
        ...
        "layers": {
            ...
            "altshiftcapslock": getKeyOutput(
                key, modifier=altshiftKey, locked=capslockKey
            ),
            "altshiftnumlock": getKeyOutput(
                key, modifier=altshiftKey, locked=numlockKey
            ),
            "altnumcapslock": getKeyOutput(key, modifier=altKey, locked=capsnumKey),
            "altshiftnumcapslock": getKeyOutput(
                key, modifier=altshiftKey, locked=capsnumKey
            ),
        },
    }
